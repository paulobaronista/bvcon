  ...
  <div class="container container-off-padding">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 pull-right form">
        ...
        <form method="post" role="form" action="#">
           <h5 class="txt-resposta">O e-mail não pode ser enviado!<br/>
           Tente novamente!<br/>
           Se o problema persistir, entre em contato pelo e-mail contato@bvconstrucoes.com.br<br/>
           Ou Ligue: (11) 3508-2400</h5>
           </h5>
        </form>
