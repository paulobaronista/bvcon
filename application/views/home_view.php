...
<div id="home" class="container-fluid container-off-padding">
  <div class="container container-off-padding">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 pull-right form">
        <form method="post" role="form" action="http://www.spicycomm.com.br/formEmail/bvconstrucoes/contato">
          <div class="tel-header">Ligue agora: <span>3508-2400</span></div>  
          ...
          <div class="group-form">
            ...
            <div class="form-group">
              ...
              <textarea id="form-mensagem" class="msg form-control" rows="2" name="mss"></textarea>
            </div>  
...
<div class="container container-off-padding servicos">
  <blockquote>
    <p class="text-right"><i>REFORMA RESIDENCIAL</i></p>
  </blockquote>
...
<div class="container">
  <p class="text-center tt-banner-bonus">clientes e parceiros</p>
  <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/parceiros.png" alt="parceiros">
</div>
