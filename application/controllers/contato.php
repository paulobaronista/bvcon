...
class Contato extends CI_Controller{
	...
	public function index(){
		...
		if($this->input->post('enviar_email') == "enviar"){			
			...
			$assunto = utf8_decode('Contato enviado pelo site www.bvconstrucoes.com.br ');
			...
			$this->email->cc('leadsreformeja@gmail.com, montenegro@brev.com.br, paulobaronista@gmail.com, fabiocastro@brev.com.br');
			...
			if($this->email->send()){				
				redirect('http://www.bvconstrucoes.com.br/contato/obrigado');
			}else{
				redirect('http://www.bvconstrucoes.com.br/contato/fail');
			}
